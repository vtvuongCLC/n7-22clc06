...
bool UploadListofStud(Course* &curCourse,StudyClass* curClass){
    ...
    ifstream in;
    int i = 1;
    in.open(curCourse->thisCourse.courseName+".csv");
    if(!in.is_open()){
...
void EnterCourseData(Course* &firstCour)
{
    ...
    getline(cin,firstCour->thisCourse.courseID);
    cout<<"Enter course name: ";
    getline(cin,firstCour->thisCourse.courseName);
    cout<<"Enter class name: ";
    getline(cin,firstCour->thisCourse.className);
    cout<<"Enter teacher name: ";
    getline(cin,firstCour->thisCourse.Teacher);
    cout<<"Enter number of credits: ";
    cin>>firstCour->thisCourse.credit;
    cout<<"Enter max number of students: ";
    cin>>firstCour->maxStudent;
    cin.ignore();
    cout<<"Enter session for course"<<endl;
    cout<<"=> Day of the week: ";
    getline(cin,firstCour->thisCourse.CourseDate.day);
    cout<<"=> Session for that day: ";
    getline(cin,firstCour->thisCourse.CourseDate.session);
}
